...
let newLogoColour = (document.querySelector("p.logo-text").style.color =
  "#384241");
...
let pasteIngredientsList = document.querySelectorAll(
...
let currentPasteIngredientsList = document.querySelector(
